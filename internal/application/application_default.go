...
func (a *ApplicationDefault) SetUp() (err error) {
	...
	a.router.Route("/customers", func(r chi.Router) {
		...
		r.Get("/totalAmountGroupByCondition", hdCustomer.GetTotalAmountGroupByCondition())
		r.Get("/activeWithHighestAmountSpent", hdCustomer.GetActiveWithHighestAmountSpent())
	...
	a.router.Route("/products", func(r chi.Router) {
		...
		r.Get("/topFiveBestSeller", hdProduct.GetTopFiveBestSeller())
		// - POST /products
	...
	a.router.Route("/invoices", func(r chi.Router) {
		...
		// - PUT
		r.Put("/total", hdInvoice.UpdateInvoicesTotal())
	})
