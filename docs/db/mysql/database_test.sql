-- Create user
 CREATE USER IF NOT EXISTS 'fantasy_products'@'%' IDENTIFIED BY 'fantasy_products';
-- Grant privileges to user for schema fantasy_products
GRANT ALL PRIVILEGES ON `fantasy_products_test`.* TO 'fantasy_products_test'@'%';
